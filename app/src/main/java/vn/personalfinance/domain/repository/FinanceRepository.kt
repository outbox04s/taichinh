...
data class DebtInput(val name:String,val lenderName:String,val debtType:String,val originalPrincipal:Long,val currentPrincipal:Long,val interestRate:Double?,val interestType:String,val startDate:LocalDate,val maturityDate:LocalDate?,val paymentFrequency:String,val expectedPaymentAmount:Long,val nextDueDate:LocalDate,val note:String?)
...
interface FinanceRepository {
    ...
    suspend fun confirmDebtSettlement(debtId:String):Result<Unit>
