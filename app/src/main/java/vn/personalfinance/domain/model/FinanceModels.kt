...
data class FinancialAccount(val id: String, val name: String, val type: String, val currentBalance: Long, val active: Boolean = true)
...
data class Debt(val id:String,val name:String,val lenderName:String?,val debtType:String,val originalPrincipal:Long,val currentPrincipal:Long,val interestRate:Double?,val interestType:String,val startDate:LocalDate,val maturityDate:LocalDate?,val paymentFrequency:String,val expectedPaymentAmount:Long,val nextDueDate:LocalDate?,val status:String,val note:String?)
